...
class Labor_Contract_Information(BaseModel):
    ...
    data_of_birth: str = Field(None, description="Date of Birth of the Employee")
    passport_number: str = Field(None, description="Passport Number of the Employee")
    position: str = Field(None, description="Position of the Employee Find in article (1) box ")
    employee_sign_status: str = Field(None, description="In Seond party's signature box is signed or not")    
    ...
    basic_salary    = Field(None, description="Basic Salary of the Employee minus all allowances not the total salary")
